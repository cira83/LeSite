...
<ol>
	...
	<li>Placer sur le schéma TI y<sub>1</sub>, y<sub>2</sub>, &epsilon;, &theta; et  &theta;c que l'on trouvent sur le schéma fonctionnel.</li>
	<li>Déterminer un modèle du premier ordre (Broïda) de H(p) en utilisant la méthode de simple, pour un échelon de commande de 50% à 80%. La commande de ventilation sera fixée à 65%.</li>
	<li>Donner la fonction de transfert du procédé H(p).</li>
	<li>Déterminer un modèle du premier ordre (Broïda) de Hz(p) en utilisant la méthode de simple, pour un échelon de commande de 50% à 80%. La commande de chauffage sera fixée à 65%.</li>
